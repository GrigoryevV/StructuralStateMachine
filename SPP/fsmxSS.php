<html>
<!-- <script language = 'javascript'>  setInterval("document.location.href='http://192.168.1.163/fsmxS.php'", 3000);</script>  -->
...
if(isset($_GET['command'])) {
    ...
    if ($nextState != 0)  {$db->query("insert into activeStates(activeState,sessionID,ip) values (".$nextState.",'".$sessionID."','".$ip."')");
