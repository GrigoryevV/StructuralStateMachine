...
<p>12. Скрипт fsmxS.php - эмуляция логина роли в приложение. Показано, что залогиненная роль может открыть страницу только активного и привязанного к ней состояния. Cookies не отключайте.
