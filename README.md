...
<p>В PHP при принудительном открытии веб-страницы (путём предачи GET-параметро в URL) для неактивного сосояния или состояния не привязанного к роли внизу страницы отсутсвуют ссылки для перехода в другие состояния согласно диаграмме перехода автомата.
